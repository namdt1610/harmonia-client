...
export default function PlaylistCard({ playlist }: PlaylistCardProps) {
    return (
        <div className="bg-neutral-800/30 rounded-lg p-3 sm:p-4 hover:bg-neutral-700/30 transition-all group">
            ...
            <h3 className="font-bold mb-1 truncate text-sm sm:text-base">{playlist.title}</h3>
            <p className="text-neutral-400 text-xs sm:text-sm line-clamp-2">{playlist.description}</p>
        </div>
    );
}