...
import { togglePlayPause, updateCurrentTime } from '@/redux/slices/playerSlice';

export const usePlayer = () => {
      const dispatch = useDispatch();
      const { currentSong, isPlaying, currentTime } = useSelector((state: RootState) => state.player);
      ...
      return {
            ...
            formatTime,
            isLoading: currentSong && !error && audioRef.current && !audioRef.current.duration,
            isError: !!error,
            error
      };
};